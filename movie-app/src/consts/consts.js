//Search Component
export const websiteTitle = "The Binger";
...
export const successMessage = 'Purchase was successful. Navigating to homepage in: '
...
export const genreSelectText =" Genres, Hold CTRL(windows) or Command(Mac) button to select multiple genres"